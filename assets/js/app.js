...
//Render High Score link  to view high score on right side
...
const startTimeQuiz = () => {
  ...
  timerDisplay.innerHTML = ""
  renderHighScoreLink()
  //Every time the time quiz is started the questions are shuffled and so are the choices in each question
  startCountDown()
  showQuiz(quiz[index])
}
